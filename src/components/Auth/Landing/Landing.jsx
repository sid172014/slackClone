        ...
        <div className="min-h-screen bg-gray-300 flex flex-col items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl">
                ...
                <p className="text-center text-sm text-gray-600 mb-4">
                    Confirmed as <strong>deepakdas538@gmail.com</strong> <a href="#" className="text-blue-500">Change</a>
                </p>
                ...
                <button className="bg-purple-700 text-white rounded-lg w-full py-2 mb-4">Create a workspace</button>
                ...
                <div className="bg-gray-100 p-4 rounded-lg mb-4">
                    ...
                    <p className="text-center text-gray-700">Workspaces for deepakdas538@gmail.com</p>
                </div>
